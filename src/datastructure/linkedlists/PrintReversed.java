...
public class PrintReversed {
    static void reversePrint(SinglyLinkedList.Node head) {
        SinglyLinkedList.Node current = new SinglyLinkedList.Node(head.data);
        current = head;
    ...
    public static void main(String[] args){
        ...
        int[] data = new int[]{3, 5, 16, 12, 4, 2, 5, 3, 9, 5, 5, 1, 18, 3, 13};
        for (int datum : data) {
            list.insertNode(datum);
        }
