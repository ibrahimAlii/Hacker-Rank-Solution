...
public class MigratoryBirds {
    ...
    static int migratoryBirds(List<Integer> arr) {
        ...
        for(int i = ids.length - 1; i >= 0; i--){
            if(ids[i] >= maxLowestOccurrences) {
                maxLowestOccurrences = ids[i];
                type = i;
            }
        }
    ...
    public static void main(String args[]){
        ...
        // list.add(1); list.add(4); list.add(4); list.add(4); list.add(5); list.add(3);

        list.add(1); list.add(2); list.add(3); list.add(4); list.add(5); list.add(3); list.add(2); list.add(1); list.add(3); list.add(4);
