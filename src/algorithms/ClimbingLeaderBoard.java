...
For example, the four players on the leaderboard have high scores of , , , and . Those players will have ranks , , , and ,
 respectively. If Alice's scores are ,  and , her rankings after each game are ,  and .
    ...
    static int[] climbingLeaderboard(int[] scores, int[] alice) {
        ...
        for (; aliceIndex >= 0; ) {
            ...
            for (; scoreIndex < scores.length; scoreIndex++) {
                ...
                if (alice[aliceIndex] < scores[scoreIndex] && scores[scoreIndex] != lastScore) {
                    rank++;
                    lastScore = scores[scoreIndex];
                }
